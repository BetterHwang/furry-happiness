...
//        viewBaiduMap?.mapType = UInt(BMKMapTypeStandard)
...
//
//        let annotation = MapServicePointAnnotation()
//        annotation.title = "实施"
...
//        if nil != annotation && annotation.isKind(of: MapServicePointAnnotation.classForCoder()) {
//
...
//                annotationView = MapServicePointAnnotationView(annotation: annotation as! MapServicePointAnnotation, identifier: "MapServicePointAnnotationView")
//            }
//
//            //            let annotationView = ServicePointAnnotationView()
//            annotationView?.annotationServicePoint =  annotation as? MapServicePointAnnotation
